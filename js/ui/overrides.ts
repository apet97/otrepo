...
export function renderOverridesPage(): void {
    ...
    if (!store.users.length) {
        container.innerHTML =
            '<div class="card"><p class="muted">No users loaded. Generate a report first to see users.</p></div>';
        return;
    }
    ...
    pageUsers.forEach((user) => {
        ...
        const placeholder =
            profileCapacity != null ? profileCapacity : store.calcParams.dailyThreshold;
        ...
        card.innerHTML = `
            ...
            <div class="override-fields-grid">
                ...
                <div class="override-field">
                    ...
                    <input type="number"
                           class="override-input ${override.capacity != null ? '' : 'inherited'}"
                           data-userid="${safeUserId}"
                           data-field="capacity"
                ...
                <div class="override-field">
                    ...
                    <input type="number"
                           class="override-input ${override.multiplier != null ? '' : 'inherited'}"
                           data-userid="${safeUserId}"
                ...
                ${
                    store.config.enableTieredOT
                        ? `<div class="override-field">
                    <label>Tier2 Threshold (hrs)</label>
                    <input type="number"
                           class="override-input ${override.tier2Threshold != null ? '' : 'inherited'}"
                           data-userid="${safeUserId}"
                ...
                <div class="override-field">
                    ...
                    <input type="number"
                           class="override-input ${override.tier2Multiplier != null ? '' : 'inherited'}"
                           data-userid="${safeUserId}"
...
function renderPerDayInputs(
    ...
    const hasGlobalValues = override.capacity != null || override.multiplier != null;
    ...
    if (hasGlobalValues) {
        ...
        html +=
            ...
            escapeHtml(String(override.capacity ?? 'default')) +
            ', Multiplier: ' +
            escapeHtml(String(override.multiplier ?? 'default')) +
            ')</span>';
        html += '</div>';
    }
