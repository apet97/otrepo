...
test.describe('Report Generation', () => {
    ...
    test('generates report when clicking Generate button', async ({ page }) => {
        ...
        await expect(page.locator('[data-testid="summary-strip"]')).toContainText('Total time');
        await expect(page.locator('[data-testid="summary-strip"]')).toContainText('9h');
    });
    ...
    test('date presets work correctly', async ({ page }) => {
        // Frozen time: 2025-01-15 (Wednesday)
        // "This Week" should produce Monday 2025-01-13 → today 2025-01-15
        ...
        expect(startDateValue).toBe('2025-01-13');
        expect(endDateValue).toBe('2025-01-15');
    });
